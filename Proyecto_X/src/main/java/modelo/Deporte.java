...
public class Deporte {
	...
	/**
	 * Método que inserta los datos recibidos del DaoDeporte en los atributos de la
	 * clase Deporte. Este método sirve de enlace entre el Servlet SV_deporte, donde
	 * es llamado, y el DaoDeporte.
	 * 
