...
/**
 * Clase Miembro
 * Incluye atributos y métodos específicos para la gestión de Miembros.
 * El rol de Miembro es la de un Usuario registrado. Tiene mas permisisos que el  usuario visitante.
...
//Atributos	
	...
	*/	
	...
	/**
	 * Constructor completo con 9 parámetros y con herencia de Usuario.
	 * El permiso de acceso para el miembro es siempre 1. Este valor es asignado automaticmanete en la base de datos.
...
// Constructor entero con herencia de usuario.
	 ...
	 * Es utilizado para recibir por primera vez los datos del Formulario (DaoMiembro). 
...
// Constructor sin permiso e id. (Para insertar del formulario a la BD)
	 ...
	 * Solo atributo Foto.
	 * Se utiliza para hacer la petición a la base de datos y recibir la foto del id concreto (DaoMiembro).
	 * Esta foto se envía al header del formulario para identificar al Miembro cuando hace login.
     * @param foto Foto personal del miembro.
	 */
...
//Metodo toString ---
	...
	/**
	 * Método que inserta los datos recibidos del DaoMiembro en los atributos de la clase Miembro.
	 * Este método sirve de enlace entre el Servlet SV_miembro, donde es llamado, y el DaoMiembro.
	...
	/**
	 * Este método se utiliza en el momento del login del miembro.
	 * Se recibe el parametro pass del servlet SV_miembro y se compara con el recibido de la base de datos.
	 * 
	 ...
	 * 					  y se inyectan en el objeto Miembro. La variable "ok" devolvería true.</li>
	 ...
	 */
		...
		/**
		 * Método que va a modificar los datos de un miembro por su id. Recibimos los datos del dao y los insertamos en el objeto "m".
		...
		/**
		 * Recibe la foto del miembro mediante su ID para mostrarla en el formulario después del inicio de sesión.
