...
/**
 * Clase Administrador Esta clase se extiende a la clase Usuario. Incluye
 * atributos y métodos específicos para la gestión de administradores.
 * 
...
public class Administrador extends Usuario {
	...
	/**
	 * Constructor completo de 7 parámetros con herencia de Usuario. El permiso de
	 * acceso para los administradores es siempre 2. Este valor se asigna
	 * automáticamente en la base de datos. Este constructor se utiliza para listar
	 * todos los datos del administrador, así como para la inserción. También se
	 * utiliza para hacer inicio de sesión y pdoer guardar los datos deseados.
	 * 
	...
	public Administrador(String nombre, String apellidos, String email, String poblacion, int permiso, String foto,
			String pass, int idaministrador) {
	 ...
	 * utilizado para recibir por primera vez los datos del Formulario
	 * (DaoAdministrador). El id se recibe en la base de datos, y permiso en el
	 * constructor.
	 * 
	 * @param nombre    Nombre del administrador.
	 * @param apellidos Apellidos del administrador.
	...
	/**
	 * Constructor con herencia de Usuario, sin atributo de pass. Este constructor
	 * se utiliza para listar los datos en el formulario. Por lo que no es necesario
	 * el pass.
	 * 
	 * @param nombre         Nombre del administrador.
	 * @param apellidos      Apellidos del administrador.
	 ...
	 * (DaoAdministrador). Esta foto se envía al header del formulario para
	 * identificar al Administrador cuando hace login.
	 * 
	 * @param foto Foto personal del administrador.
	 */
	...
	/**
	 * Método que inserta los datos recibidos del DaoAdministrador en los atributos
	 * de la clase Administrador. Este método sirve de enlace entre el Servlet
	 * SV_administrador, donde es llamado, y el DaoAdministrador.
	 * 
	...
	/**
	 * Este método se utiliza en el momento del login del administrador. Se recibe
	 * el parametro pass del servlet SV_administrador y se compara con el recibido
	 * de la base de datos.
	 * 
	 ...
	 *         objeto Administrador. La variable "ok" devolvería true.</li>
	...
	/**
	 * Método que va a modificar los datos de un administrador por su id. Recibimos
	 * los datos del dao y los insertamos en el objeto "a".
	 * 
	...
	/**
	 * Recibe la foto del administrador mediante su ID para mostrarla en el
	 * formulario después del inicio de sesión.
	 * 
